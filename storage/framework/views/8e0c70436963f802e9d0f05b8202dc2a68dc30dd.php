            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('2fa.post')); ?>">
                        ...
                        <p class="text-center">Confirmez qu'il s'agit bien de vous en entrant le code d'identification qui vous a été envoyé sur : <?php echo e(substr(auth()->user()->email, 0, 5) . '******' . substr(auth()->user()->email,  -2)); ?></p>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0 py-10 my-6">
                            <div class="col-md-6 ">
                                <a class="btn btn-link" href="<?php echo e(route('2fa.resend')); ?>">Renvoyez le code?</a>
                            </div>
...
<?php endif; ?>
                                ...
                                <span><?php echo e(__('Valider')); ?></span>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?><?php /**PATH /var/www/top-patissier.net/resources/views/2fa.blade.php ENDPATH**/ ?>