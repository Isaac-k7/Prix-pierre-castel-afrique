...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        ...
        <form method="post" action="<?php echo e(route('pays.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-3 sm:col-span-1">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text" name="code" value="<?php echo e(old('code')); ?>" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full form-control rounded-none rounded-r-md sm:text-sm border-gray-300 <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Code pays">
                            </div>
...
<?php endif; ?><?php /**PATH /var/www/top-patissier.net/resources/views/admin/pays/add.blade.php ENDPATH**/ ?>